...
tools/                   every routine that would otherwise be a thing to remember
  ...
  routes.py              the route reference: write it, check it, walk the graph from any name
...
docs/                    how it works underneath, in prose
  ...
  reference/routes.md    GENERATED by the build: every field, section and table, drawn and described
