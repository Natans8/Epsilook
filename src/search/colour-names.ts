 ...
 * met, and a name outside it is refused rather than guessed at. The list itself is the vendored `color-name` package,
 * upstream verbatim; this module only packs its channel triplets into the 0xRRGGBB integers the data stores. Names
 * are read on input and never written — a stored colour always prints as its hex triplet.
 */
import colors from "../vendor/color-name.js";
