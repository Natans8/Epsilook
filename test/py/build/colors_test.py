...
from pack.routes.colors import hue_word, hue_words, pack_rgb, to_channel, unpack_rgb
...
@pytest.mark.parametrize("channels", [(255, 255, 255), (128, 128, 128), (0, 0, 0), (10, 10, 12)])
...
def test_several_colours_give_each_word_once_in_order() -> None:
    assert hue_words((pack_rgb(255, 0, 0), pack_rgb(0, 0, 255), pack_rgb(200, 0, 0))) == "red blue"
...
@pytest.mark.parametrize(("text", "byte"), [("0", 0), ("1", 255), ("0.5", 128), ("", 0), ("2", 255), ("-1", 0)])
