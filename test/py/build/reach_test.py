...
def test_a_spell_naming_no_band_is_left_out(tables: BuildTables) -> None:
    ...
    assert reach_of(tables, {100: 0}) == []
    assert reach_of(tables, {100: 999}) == []
