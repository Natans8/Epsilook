...
98 declared fields, in `build/pack/routes/flows.py`, in declaration order:
...
| effects              | a spell's effects, and who each is aimed at, split into 22 landings                                                                                                                                                                                                                            | SpellEffect                                                                | keybinds, names.names, screens, summon_controls, target_bits                                                                                                                                                                                                                       | SpellEffectRows                    |
