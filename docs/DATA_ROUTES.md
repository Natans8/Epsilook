...
| kit_names            | the names the pinned build gives the sound kits this pack reaches                                                                                                                                                                                                                              | SoundKitName (pinned)                                       | used_kits                                                                                                                                                                                                                                                                          | rows                               |
...
| objects              | the gameobjects a spell spawns, named and modelled                                                                                                                                                                                                                                             | gameobject_template (world), GameObjectDisplayInfo          | none                                                                                                                                                                                                                                                                               | rows, then assemble                |
| mounts               | the displays a mount-granting spell puts you on                                                                                                                                                                                                                                                | Mount, MountXDisplay                                        | creatures, names.names                                                                                                                                                                                                                                                             | rows, then assemble                |
| creature_names       | what the server calls each creature                                                                                                                                                                                                                                                            | creature_template (world)                                   | none                                                                                                                                                                                                                                                                               | map                                |
| creature_displays    | the displays a creature wears, by slot                                                                                                                                                                                                                                                         | creature_template_model (world), creature_template (world)  | none                                                                                                                                                                                                                                                                               | sets, then ordered                 |
...
| totem_displays       | the displays a totem wears, one per caster race                                                                                                                                                                                                                                                | spell_totem_model (world)                                   | none                                                                                                                                                                                                                                                                               | sets, then ordered                 |
...
| effect_values        | the numbers a template asks of each effect, split into 6 landings                                                                                                                                                                                                                              | SpellEffect (base), SpellScaling (base), SpellRadius (base) | level, scaling                                                                                                                                                                                                                                                                     | EffectValues                       |
| spell_durations      | how long a spell lasts                                                                                                                                                                                                                                                                         | SpellMisc (base), SpellDuration (base)                      | none                                                                                                                                                                                                                                                                               | map                                |
| spell_ranges         | how far a spell's description says it reaches                                                                                                                                                                                                                                                  | SpellMisc (base), SpellRange (base)                         | none                                                                                                                                                                                                                                                                               | map                                |
| spell_stack_caps     | what an aura's options cap                                                                                                                                                                                                                                                                     | SpellAuraOptions (base)                                     | none                                                                                                                                                                                                                                                                               | map                                |
| spell_charges        | what an aura's options cap                                                                                                                                                                                                                                                                     | SpellAuraOptions (base)                                     | none                                                                                                                                                                                                                                                                               | map                                |
| spell_proc_chances   | what an aura's options cap                                                                                                                                                                                                                                                                     | SpellAuraOptions (base)                                     | none                                                                                                                                                                                                                                                                               | map                                |
| spell_target_caps    | what a spell's targeting caps                                                                                                                                                                                                                                                                  | SpellTargetRestrictions (base)                              | none                                                                                                                                                                                                                                                                               | map                                |
| spell_target_levels  | what a spell's targeting caps                                                                                                                                                                                                                                                                  | SpellTargetRestrictions (base)                              | none                                                                                                                                                                                                                                                                               | map                                |
